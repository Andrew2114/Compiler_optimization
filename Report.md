...
\begin{flushright}
    Группа: \emph{25.Б41-мм}\quad\\[2pt]
    Кафедра: \emph{кафедра системного программирования}\\[2pt]
    Научный руководитель: \emph{Инженер-исследователь Романова Зинаида Андреевна}\\[2pt]
...
.}
(\texttt{optbench.c}), разработанный для проверки компиляторных
